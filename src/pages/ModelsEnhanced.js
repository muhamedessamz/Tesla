          ...
          <div className="row align-items-center mb-4">
            ...
            <div className="col-md-6 text-center">
              <div className="position-relative">
                <img src="https://www.tesla.com/sites/tesla/files/model-s-hero.jpg?202211170905" className="img-fluid rounded" alt="Model S" />
      ...
      <div className="mb-5">
        <div className="container">
          <div className="row align-items-center mb-4 flex-md-row-reverse">
            <div className="col-md-6 text-center">
              <div className="position-relative">
                <img src="https://www.tesla.com/sites/tesla/files/model-3-hero.jpg?202211170905" className="img-fluid rounded" alt="Model 3" />
                <div className="position-absolute bottom-0 start-50 translate-middle-x mb-3 d-none d-md-block">
                  <button className="btn btn-sm btn-light"><i className="bi bi-play-fill me-2"></i>Watch</button>
                </div>
              </div>
      ...
      <div className="mb-5">
        <div className="container">
          <div className="row align-items-center mb-4">
            ...
            <div className="col-md-6 text-center">
              <div className="position-relative">
                <img src="https://www.tesla.com/sites/tesla/files/model-x-hero.jpg?202211170905" className="img-fluid rounded" alt="Model X" />
                <div className="position-absolute bottom-0 start-50 translate-middle-x mb-3 d-none d-md-block">
                  <button className="btn btn-sm btn-light"><i className="bi bi-play-fill me-2"></i>Watch</button>
                </div>
              </div>
      ...
      <div className="mb-5">
        <div className="container">
          <div className="row align-items-center mb-4 flex-md-row-reverse">
            <div className="col-md-6 text-center">
              <div className="position-relative">
                <img src="https://www.tesla.com/sites/tesla/files/model-y-hero.jpg?202211170905" className="img-fluid rounded" alt="Model Y" />
                <div className="position-absolute bottom-0 start-50 translate-middle-x mb-3 d-none d-md-block">
                  <button className="btn btn-sm btn-light"><i className="bi bi-play-fill me-2"></i>Watch</button>
                </div>
              </div>
      ...
      <div className="mb-5">
        <div className="container">
          <div className="row align-items-center mb-4">
            ...
            <div className="col-md-6 text-center">
              <div className="position-relative">
                <img src="https://www.tesla.com/sites/tesla/files/cybertruck-hero.jpg?202211170905" className="img-fluid rounded" alt="Cybertruck" />
                <div className="position-absolute bottom-0 start-50 translate-middle-x mb-3 d-none d-md-block">
                  <button className="btn btn-sm btn-light"><i className="bi bi-play-fill me-2"></i>Watch</button>
                </div>
              </div>
