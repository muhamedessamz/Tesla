        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              <img src="https://via.placeholder.com/800x500" className="img-fluid rounded shadow" alt="Tesla Mission" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mb-5 bg-light text-dark py-5">
        <div className="container">
          <div className="row align-items-center flex-md-row-reverse">
            <div className="col-lg-6 mb-4 mb-lg-0">
              <img src="https://via.placeholder.com/800x500" className="img-fluid rounded shadow" alt="Tesla Innovation" />
            </div>
            <div className="col-lg-6">
      ...
      <div className="mb-5">
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              <img src="https://via.placeholder.com/800x500" className="img-fluid rounded shadow" alt="Tesla Sustainability" />
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="row g-4">
            <div className="col-md-4">
              <div className="card h-100 border-0 shadow-sm">
                <div className="card-body text-center p-4">
                  <div className="mb-3">
                    <img src="https://via.placeholder.com/150x150" className="rounded-circle" alt="CEO" />
                  </div>
            ...
            <div className="col-md-4">
              <div className="card h-100 border-0 shadow-sm">
                <div className="card-body text-center p-4">
                  <div className="mb-3">
                    <img src="https://via.placeholder.com/150x150" className="rounded-circle" alt="CFO" />
                  </div>
            ...
            <div className="col-md-4">
              <div className="card h-100 border-0 shadow-sm">
                <div className="card-body text-center p-4">
                  <div className="mb-3">
                    <img src="https://via.placeholder.com/150x150" className="rounded-circle" alt="CTO" />
                  </div>
